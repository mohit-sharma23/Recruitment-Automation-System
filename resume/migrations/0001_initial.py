    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('candidateId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='work', to='resume.candidate')),
            ],
        ),
        migrations.CreateModel(
            name='Skill',
            fields=[
                ...
                ('candidateId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='skill', to='resume.candidate')),
            ],
        ),
        migrations.CreateModel(
            name='Resume',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('candidateId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='resu', to='resume.candidate')),
            ],
        ),
        migrations.CreateModel(
            name='Projects',
            fields=[
                ...
                ('candidateId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='project', to='resume.candidate')),
            ],
        ),
        migrations.CreateModel(
            name='Course',
            fields=[
                ...
                ('candidateId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='course', to='resume.candidate')),
            ],
        ),
    ]
